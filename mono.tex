...
\autor{Yuri Soares de Oliveira\thanks{\url{soaresyuri@gmail.com}} \and Cidcley Teixeira de Souza\thanks{cidcley@ifce.edu.br}}
...
\begin{document}
  ...
  Com o uso massivo da \emph{Internet} a partir da década de 1990, iniciou-se um processo de narrar histórias e entreter audiências através de múltiplas plataformas. (\ldots) O que é narrativa transmídia (\ldots)
  ...
  \autoref{tab-topicos-objetivos}
  \begin{table}[htb]
    \ABNTEXfontereduzida
    \caption[Tópicos e objetivos]{Tópicos e objetivos.}
